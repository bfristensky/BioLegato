...
public class FileChooser extends AbstractFileChooser {
    ...
    public static final Icon WIDGET_ICON = new ImageIcon(
            FileChooser.class.getClassLoader().getResource(
                    "org/biopcd/icons/filechooser.png"));
    ...
    public FileChooser(String name) {
        super(name, JFileChooser.FILES_ONLY, "Choose file...");
    }
     ...
     */
    public FileChooser(String name, String label, String value) {
        super(name, label, value, JFileChooser.FILES_ONLY, "Choose file...");
    }
