...
import org.biopcd.widgets.Chooser;

/**
 *
 * @author alvare
 */
public class BooleanField extends Chooser implements DBField {
    ...
    public BooleanField (String name, String label) {
        super(name, label, booleanValues, booleanValues, 0);
    }
