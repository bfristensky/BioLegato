...
import org.biopcd.widgets.NumberWidget;

/**
 *
 * @author alvare
 */
public class NumberField extends NumberWidget implements KeyableField {
     ...
     */
    public NumberField (String name, String label, int min, int max) {
        super(name, label, min, max, min);
    }
    ...
    public String save(String keyvalue) {
        String result = getInstance().getValue().toString();
